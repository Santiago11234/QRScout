...
export async function addGame(gameData: Game): Promise<void> {
 ...
 if (teamDocSnap.exists()) {
    ...
    const newAverages: Partial<Team> = {
      ...
      whereShot: [...teamData.whereShot, gameData.whereShot],
      comments: [...teamData.comments, gameData.comment],
      foulComments: [...teamData.foulComments, gameData.foulComment],
      shuttleComments: [...teamData.shuttleComments, gameData.shuttleComment],
    };
    ...
    const newTeam: Team = {
      ...
      whereShot: [gameData.whereShot],
      comments: [gameData.comment],
      foulComments: [gameData.foulComment],
      shuttleComments: [gameData.shuttleComment],
