...
export async function addGame(gameData: Game): Promise<void> {
 ...
 if (teamDocSnap.exists()) {
    ...
    const newAverages: Partial<Team> = {
       ...
       avgOffensiveSkill: (teamData.avgOffensiveSkill * newGamesPlayed + gameData.offensiveSkill) / (newGamesPlayed + 1),
       avgDefensiveSkill: (teamData.avgDefensiveSkill * newGamesPlayed + gameData.defensiveSkill) / (newGamesPlayed + 1),
    ...
    const newTeam: Team = {
       ...
       avgOffensiveSkill: gameData.offensiveSkill,
       avgDefensiveSkill: gameData.defensiveSkill,
